/**
 * Prompt d'analyse d'etiquette nutritionnelle — VERSION CANONIQUE
 *
 * ATTENTION : duplique a l'identique dans app/lib/data/vision/label_prompt.dart
 * Meme PROMPT_VERSION des deux cotes, verifie par tools/check_prompt_sync.py.
 */

export const LABEL_PROMPT_VERSION = "label-v1";

export const LABEL_SYSTEM_PROMPT = `Tu es un assistant specialise dans la lecture d'etiquettes nutritionnelles.
...
export function buildLabelUserPrompt(hasSecondImage: boolean): string {
