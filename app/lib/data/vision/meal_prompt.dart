/// Prompt d'analyse de repas — copie de l'application.
///
/// ATTENTION : ce texte doit rester aligne avec sa copie TypeScript
/// `backend/supabase/functions/_shared/meal_prompt.ts`.
/// Les deux doivent declarer le meme [promptVersion].
/// Le controle `tools/check_prompt_sync.py`, execute en CI, verifie cet accord.
library;

const String promptVersion = 'meal-v1';

const String mealSystemPrompt = '''
Tu es un assistant nutritionniste specialise dans l'estimation visuelle de portions.
...
/// Construit l'instruction utilisateur accompagnee de la ou des photos.
String buildMealUserPrompt({
  String? portionHint,
  String? userHint,
  ...
  if (hasSecondImage) {
    ...
    parts.add('Une photo du repas est fournie.');
  }
