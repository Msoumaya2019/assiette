...
python tools/lancer_bancs.py              # les vingt-deux bancs de falsification
```
...
rangée dans le trousseau — jetons et adresse du compte**, la **section Compte** des réglages : se
